...
**Problem:** [1367B-Even-Array](https://codeforces.com/contest/1367/problem/B)
...
An array is called good if the parity of each index matches the parity of the element at that index. More formally, an array is good if for all i (0 ≤ i ≤ n - 1) the equality i \bmod 2 = a[i] \bmod 2 holds, where x \bmod 2 is the remainder of dividing x by 2.
