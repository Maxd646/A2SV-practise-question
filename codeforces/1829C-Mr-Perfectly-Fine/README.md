...
**Problem:** [1829C-Mr-Perfectly-Fine](https://codeforces.com/contest/1829/problem/C)
...
The input consists of multiple test cases. The first line contains an integer t (1 ≤q t ≤q 1000) — the number of test cases. The description of the test cases follows.

The first line of each test case contains an integer n (1 ≤q n ≤q 2 ⋅ 10⁵) — the number of books available.

Then n lines follow. Line i contains a positive integer m_i (1 ≤q m_i ≤q 2 ⋅ 10⁵) and a binary string of length 2, where s_{i1} = 1 if reading book i acquires Victor skill 1, and s_{i1} = 0 otherwise, and s_{i2} = 1 if reading book i acquires Victor skill 2, and s_{i2} = 0 otherwise.

It is guaranteed that the sum of n over all test cases doesn't exceed 2 ⋅ 10⁵.
