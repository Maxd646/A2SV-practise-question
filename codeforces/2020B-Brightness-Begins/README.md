...
**Problem:** [2020B-Brightness-Begins](https://codeforces.com/contest/2020/problem/B)
...
-  for each i = 1, 2, …, n, flip the state of all bulbs j such that j is divisible by i^\dagger. 
...
^\dagger An integer x is divisible by y if there exists an integer z such that x = y⋅ z.
...
The only line of each test case contains a single integer k (1 ≤ k ≤ 10^{18}).
