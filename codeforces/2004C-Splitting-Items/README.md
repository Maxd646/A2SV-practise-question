...
**Problem:** [2004C-Splitting-Items](https://codeforces.com/contest/2004/problem/C)
...
The first line of each test case contains two integers n and k (2 ≤ n ≤ 2 ⋅ 10⁵; 0 ≤ k ≤ 10⁹) — the number of items and the maximum total increase Bob can make.

The second line of each test case contains n integers a_1, a_2, …, a_n (1 ≤ a_i ≤ 10⁹) — the initial costs of the items.
...
In the third test case, Bob, for example, can increase a_1 by 1, a_2 by 3, and a_3 by 2. The total change is equal to 1 + 3 + 2 ≤ 6 and costs will be equal to [4, 4, 4, 4]. Obviously, the score will be equal to (4 + 4) - (4 + 4) = 0.
