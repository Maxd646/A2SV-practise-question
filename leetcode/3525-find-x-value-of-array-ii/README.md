...
For each query in `queries` you need to determine the **x-value** of `nums` for `x i` after performing the following actions:
...
Example 1:**Input:** nums = [1,2,3,4,5], k = 3, queries = [[2,2,0,2],[3,3,3,0],[0,1,0,1]]
...
Example 2:**Input:** nums = [1,2,4,8,16,32], k = 4, queries = [[0,2,0,2],[0,2,0,1]]
