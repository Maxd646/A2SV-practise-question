...
, erase it from p
and insert it into string s
(you may insert this character anywhere you want: in the beginning of s
, in the end or between any two consecutive characters).

For example, if p
is aba, and s
is de, then the following outcomes are possible (the character we erase from p
and insert into s
is highlighted):
...
The third line of each query contains the string p
(1≤|p|≤100
) consisting of lowercase Latin letters.
...
[From S To T](https://codeforces.com/contest/1/problem/E)
